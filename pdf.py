...
def resize_and_convert_image(image_path, max_size=(1280, 720), quality=85):
...
def pngs_to_pdf(source_folder, output_pdf, max_image_size, jpeg_quality):
    ...
    for i in range(1, 1535):
        ...
        if os.path.exists(file_path):
            img = resize_and_convert_image(file_path, max_size=max_image_size, quality=jpeg_quality)
